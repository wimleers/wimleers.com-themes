  ...
  <section class="main c16 cf">
    ...
    <?php else: ?>
      <article class="g9">
        ...
        <?php if ($rendered_tabs = render(isset($tabs) ? $tabs : array())): ?><div class="tabs g9"><?php print $rendered_tabs; ?></div><?php endif; ?>
        <?php print render($page['help']); ?>
        <?php if (isset($action_links)): ?><ul class="action-links"><?php print render($action_links); ?></ul><?php endif; ?>
        <?php print render($page['content']); ?>
      </article>
  ...
  <div class="c16 cf">
    <div class="g10">
      ...
      <p>
        ...
        Copyright 2007&ndash;2014 <a href="http://wimleers.com">Wim Leers</a>. All rights reserved.
      </p>
    </div>
    <nav class="g6">
      <ul>
